  ...
  return (
    <div className={`card p-4 ${task.status === 'completed' ? 'opacity-70' : ''}`}>
      <div className="flex items-start gap-2.5">
        ...
        <Dropdown
          trigger={<span className="inline-flex items-center gap-1 rounded-md px-2.5 py-1 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700 shadow-sm text-xs font-medium transition-colors" role="button" aria-label="Task options"><MoreVertical className="h-3.5 w-3.5" /></span>}
        >
