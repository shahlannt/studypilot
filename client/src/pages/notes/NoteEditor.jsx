...
export default function NoteEditor() {
  ...
  return (
    <div className="space-y-4 animate-slide-up">
      {/* AI Summary panel */}
      {summaryOpen && (
        <div className="rounded-xl border border-brand-200 dark:border-brand-800 bg-gradient-to-br from-brand-50 to-white dark:bg-slate-950 dark:from-slate-950 dark:to-slate-950 p-5 animate-slide-up shadow-card">
